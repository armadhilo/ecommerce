...
<div class="horizontal-menu-wrapper">
    <div class="header-navbar navbar-expand-sm navbar navbar-horizontal navbar-light navbar-without-dd-arrow navbar-shadow menu-border" role="navigation" data-menu="menu-wrapper">
        
        <!-- Horizontal menu content-->
        <div class="navbar-container main-menu-content" data-menu="menu-container"  style="border-radius: 0px; padding-top: 2px; padding-bottom: 2px;">
            ...
            <ul class="nav navbar-nav" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                <li class="dropdown nav-item active" data-menu="dropdown"><a class="nav-link" href="#"><i class="feather icon-package"></i><span data-i18n="Apps">Product</span></a>
