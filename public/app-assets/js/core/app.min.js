! function (i, r, f) {
	...
	if (f(i).on("load", function () {
			...
			var t = f(".chartjs"),
				...
				s = f(".main-menu");
			if (t.css("height", n), d.hasClass("boxed-layout") && d.hasClass("vertical-overlay-menu")) {
				var i = s.width(),
					o = f(".app-content").position().left - i;
				d.hasClass("menu-flipped") ? s.css("right", o + "px") : s.css("left", o + "px")
			}
			f(".custom-file input").change(function (e) {
				...
				! function (e, a) {
					...
					f(".char-count").html(e.value.length), e.value.length > t ? (n.css("background-color", h), s.css("color", h), s.addClass("max-limit")) : (n.css("background-color", "#3f9ce8"), s.css("color", "#4e5154"), s.removeClass("max-limit"))
		...
		var a = r.querySelector(".drag-target"),
			t = "panright",
			n = "panleft";
		if (!0 === e && (t = "panleft", n = "panright"), 0 < f(a).length) new Hammer(a).on(t, function (e) {
		...
		if (0 < f(s).length) new Hammer(s).on(n, function (e) {
			if (d.hasClass("vertical-overlay-menu")) return f.app.menu.hide(), !1
		})
	}
	...
	var v = f(".search-input input").data("search"),
		o = f(".bookmark-wrapper"),
		l = f(".bookmark-wrapper .bookmark-star"),
	...
	if (l.on("click", function (e) {
			e.stopPropagation(), g.toggleClass("show"), g.find("input").val(""), g.find("input").blur(), g.find("input").focus(), o.find(".search-list").addClass("show");
		...
		}), f(".search-list-main").length) var u = new PerfectScrollbar(".search-list-main", {
		wheelPropagation: !1
	});
	...
	f(".search-list-main").mouseenter(function () {
		...
		if (e.stopPropagation(), f(this).hasClass("warning")) {
			...
			var n;
			n = '<li class="nav-item d-none d-lg-block"><a class="nav-link" href="' + f(this).parent()[0].href + '" data-toggle="tooltip" data-placement="top" title="" data-original-title="' + f(this).parent()[0].innerText + '"><i class="ficon ' + f(this).parent()[0].firstChild.firstChild.dataset.icon + '"></i></a></li>', f("ul.nav.bookmark-icons").append(n), f('[data-toggle="tooltip"]').tooltip()
		}
	}), f(i).on("keydown", function (e) {
		var a, t, n = f(".search-list li.current_item");
		if (40 === e.keyCode ? (a = n.next(), n.removeClass("current_item"), n = a.addClass("current_item")) : 38 === e.keyCode && (t = n.prev(), n.removeClass("current_item"), n = t.addClass("current_item")), 13 === e.keyCode && 0 < f(".search-list li.current_item").length) {
			var s = f(".search-list li.current_item a");
			i.location = s.attr("href"), f(s).trigger("click")
		}
